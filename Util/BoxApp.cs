...
namespace D3D
{
    ...
    public class BoxApp : GameApp
    {
        ...
        public BoxApp(System.Object swapChainPanel) : base(swapChainPanel)
        {
        ...
        protected override void OnMouseMove(Mouse mouse, Point location)
        {
            if (mouse.left || _inputManager.isKeyDown(Keys.ControlKey))
            {
        ...
        private void BuildPSO()
        {
            var psoDesc = new GraphicsPipelineStateDescription
            {
                ...
                StreamOutput = new StreamOutputDescription() // [To do] Modified Code
            };
